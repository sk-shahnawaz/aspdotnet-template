...
internal static class AppResources
{
    ...
    internal const string ForbidRequestDueToUniqueConstraintFailure = "Duplicate item! {0} with value '{1}' already exists in Database.";
    ...
    internal const string NoItemFoundMessage = "{0} with {1}: {2} not found in Database.";
